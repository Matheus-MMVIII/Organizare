...
public class ApiServer {
    ...
    // Configura o servidor HTTP, a pool de threads, as rotas e o desligamento controlado.
    ...
    // Encerra o servidor HTTP e libera a pool de threads usada para processar requisicoes.
    public void stop() {
        server.stop(0);
        executor.shutdown();
    }

    // Cria as dependencias principais e associa cada rota ao seu respectivo handler.
